...
import {
  addDataBasesBuildings,
  editDataBasesBuildings,
} from "../../../../redux/baseBuildingReducer/actionsBaseBuilding";
...
function ModalWindow({ setShow, show, type, buildingId }) {
  ...
  const editErrors = (buttonType) => {
    if (buttonType === "save") {
      ...
      const newErrors = {};
      if (!ownerOblast || ownerOblast === "")
        newErrors.ownerOblast = "Заполните область местонахождения базы";
      ...
      if (!responPosition || responPosition === "")
        newErrors.responPosition = "Заполните должность ответственного";
